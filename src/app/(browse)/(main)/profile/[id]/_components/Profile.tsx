...
export const Profile: FC<Props> = ({ profile, isFollow, isAuth }) => {
  ...
  return (
		<div className='flex flex-col gap-8'>
			...
			<div className={'flex items-start gap-[70px] mb:max-lg:flex-col'}>
				{!!profile.songs.length && (
					<div
						className={cn(
							'flex flex-col gap-5',
							!!profile.playlists.length ? 'w-3/5 mb:max-lg:w-full' : 'w-full'
						)}
					>
				...
				{!!profile.playlists.length && (
					<div className='flex flex-col gap-5 w-2/5 mb:max-lg:w-full'>
